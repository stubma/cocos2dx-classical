...
public class LuaExporter extends BaseExporter {
	...
	public void doExport(Workbook book, Sheet sheet, File file) throws CellFormatException, IOException {
		...
		lfile.append("-- Auto generated by exportExcel, don't modify it\n")
			...
			.append("\n")
			.append("\t\t-- register unloader\n")
			.append("\t\tif _G[\"gXModelUnloadFunctions\"] ~= nil then\n")
			.append("\t\t\tlocal registry = _G[\"gXModelUnloadFunctions\"]\n")
			.append("\t\t\ttable.insert(registry, " + className + ".unload)\n")
			.append("\t\tend\n")
			.append("\tend\n")
			.append("end\n")
			.append("\n")
			.append("function " + className + ".unload()\n")
			.append("\tsJSON = nil\n")
			.append("\tsLoaded = false\n")
			.append("\tsCount = 0\n")
			.append("end\n")
			.append("\n")
