...
* 为CCScrollView添加了start_scroll/end_scroll/content_size_changed事件
* CCEGLViewProtocol添加了redispatchTouchBegin和getDispatchingTouch方法, 主要是为了方便支持拖放操作
...
* CCNode:schedule支持调度一个lua闭包, 增加了unscheduleScriptFuncByObjId和unscheduleScriptFuncByEntryId方法
...
* 为CCScrollView adds start_scroll/end_scroll/content_size_changed events
...
* CCNode:schedule supports to schedule a lua closure, and add unscheduleScriptFuncByObjId/EntryId method
