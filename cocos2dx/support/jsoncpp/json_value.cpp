...
Value::asDouble() const
{
   ...
   case stringValue:
       return value_.string_ ? atof(value_.string_) : 0;
   case arrayValue:
   case objectValue:
      return 0.0;
   default:
...
Value::asBool() const
{
   ...
   case booleanValue:
      return value_.bool_;
   case stringValue:
       return value_.string_ && (value_.string_[0] == '1' || value_.string_[0] == 'y' || value_.string_[0] == 'Y' || !strcmp("true", value_.string_));
   case arrayValue:
   case objectValue:
